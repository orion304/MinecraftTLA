...
public class Tools {
	...
	private static Integer[] plantIds = { 6, 18, 31, 32, 37, 38, 39, 40, 59,
		81, 83, 86, 99, 100, 103, 104, 105, 106, 111, 161, 175 };
	...
	public static boolean isWaterbendable(Block block, Player player) {
		...
		if ((block.getType() == Material.WATER || block.getType() == Material.STATIONARY_WATER)
				&& block.getData() == full)
			return true;
		if (block.getType() == Material.ICE || block.getType() == Material.SNOW || block.getType() == Material.PACKED_ICE) //174 is packed ice
	...
	public static void configCheck() {
		...
		bending.getConfig().addDefault("Abilities.PierceArmor", false);
		...
		ConfigValues.PierceArmor = config.getBoolean("Abilities.PierceArmor");

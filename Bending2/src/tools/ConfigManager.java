...
{	
  ...
  private MemoryConfiguration getDefaults()
  {
    ...
    config.set("Chat.Compatibility", Boolean.valueOf(true));
    ...
    config.set("Bending.Damage.AirSwipe", Integer.valueOf(1));
    config.set("Bending.Damage.EarthBlast", Integer.valueOf(7));
    config.set("Bending.Damage.WaterManipulation", Integer.valueOf(7));

	...
	private void initialize() {
		{
		    try
		    {
		      ...
		      //String createTable1 = "CREATE TABLE IF NOT EXISTS Bending ('player' TEXT NOT NULL, 'bending' TEXT NOT NULL)";
		      //String createTable2 = "CREATE TABLE IF NOT EXISTS Bending ('player' TEXT NOT NULL, 'setter' TEXT NOT NULL, 'ability' TEXT NOT NULL)";
